...
export type GetProductDetailsByIdQuery = { __typename?: 'Query', product?: { __typename?: 'Product', id: string, name: string, price: number, description: string, categories: Array<{ __typename?: 'Category', id: string, name: string }>, collections: Array<{ __typename?: 'Collection', id: string, slug: string, name: string, description?: string | null }>, reviews: Array<{ __typename?: 'Review', id: string, content: string, headline: string, name: string, rating?: number | null }>, images: Array<{ __typename?: 'Asset', id: string, height?: number | null, width?: number | null, url: string, mimeType?: string | null }> } | null };

export type GetProductsCountQueryVariables = Exact<{ [key: string]: never; }>;


export type GetProductsCountQuery = { __typename?: 'Query', productsConnection: { __typename?: 'ProductConnection', aggregate: { __typename?: 'Aggregate', count: number } } };

export type GetProductPageQueryVariables = Exact<{
  limit: Scalars['Int'];
  offset: Scalars['Int'];
}>;


export type GetProductPageQuery = { __typename?: 'Query', productsConnection: { __typename?: 'ProductConnection', products: Array<{ __typename?: 'ProductEdge', node: { __typename?: 'Product', id: string, slug: string, name: string, price: number, categories: Array<{ __typename?: 'Category', id: string, name: string }>, collections: Array<{ __typename?: 'Collection', id: string, name: string }>, reviews: Array<{ __typename?: 'Review', id: string, rating?: number | null }>, images: Array<{ __typename?: 'Asset', url: string }> } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, pageSize?: number | null } } };
 ...
 * });
 */
export function useGetProductsCountQuery(baseOptions?: Apollo.QueryHookOptions<GetProductsCountQuery, GetProductsCountQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductsCountQuery, GetProductsCountQueryVariables>(GetProductsCountDocument, options);
      }
export function useGetProductsCountLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductsCountQuery, GetProductsCountQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductsCountQuery, GetProductsCountQueryVariables>(GetProductsCountDocument, options);
        }
export type GetProductsCountQueryHookResult = ReturnType<typeof useGetProductsCountQuery>;
export type GetProductsCountLazyQueryHookResult = ReturnType<typeof useGetProductsCountLazyQuery>;
export type GetProductsCountQueryResult = Apollo.QueryResult<GetProductsCountQuery, GetProductsCountQueryVariables>;
export const GetProductPageDocument = gql`
...
/**
 * __useGetProductPageQuery__
 *
 * To run a query within a React component, call `useGetProductPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetProductPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetProductPageQuery({
 *   variables: {
 ...
 * });
 */
export function useGetProductPageQuery(baseOptions: Apollo.QueryHookOptions<GetProductPageQuery, GetProductPageQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetProductPageQuery, GetProductPageQueryVariables>(GetProductPageDocument, options);
      }
export function useGetProductPageLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetProductPageQuery, GetProductPageQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetProductPageQuery, GetProductPageQueryVariables>(GetProductPageDocument, options);
        }
export type GetProductPageQueryHookResult = ReturnType<typeof useGetProductPageQuery>;
export type GetProductPageLazyQueryHookResult = ReturnType<typeof useGetProductPageLazyQuery>;
export type GetProductPageQueryResult = Apollo.QueryResult<GetProductPageQuery, GetProductPageQueryVariables>;